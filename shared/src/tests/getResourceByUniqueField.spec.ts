...
describe('GET resource by unique field', async () => {
    ...
    papiService.getResourceByKey = async (resourceName: string, key: string) => { return Promise.resolve(JSON.parse(resolveString)); }
    papiService.getResourceByInternalId = async (resourceName: string, internalId: string) => { return Promise.resolve(JSON.parse(resolveString)); }
    papiService.getResourceByExternalId = async (resourceName: string, externalId: string) => { return Promise.resolve(JSON.parse(resolveString)); }
